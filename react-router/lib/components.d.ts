...
export declare function useRenderDataRouter({ children, fallbackElement, todo_bikeshed_routes, createRouter, }: {
...
export declare function DataMemoryRouter({ children, initialEntries, initialIndex, hydrationData, fallbackElement, todo_bikeshed_routes, }: DataMemoryRouterProps): React.ReactElement;

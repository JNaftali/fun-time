...
export declare type LoaderFormMethod = "get";
export declare type ActionFormMethod = "post" | "put" | "patch" | "delete";
export declare type FormMethod = LoaderFormMethod | ActionFormMethod;
